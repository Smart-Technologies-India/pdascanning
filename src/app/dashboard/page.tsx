  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-6 gap-4 mt-4">
              ...
              <TableBody className="">
                {yeartype.map((year: any, index: number) => (
                  ...
                  >
                    ...
                    {year.filetypelist.map((filetype: any, index: number) => (
                      <TableCell key={index} className="p-1 w-40 text-center">
                        {filetype.filecount}
                      </TableCell>
                    ))}
                  </TableRow>
        ...
        <div className="flex-1 bg-white p-2 rounded col-span-2 relative">
          ...
          <Table className="relative w-full">
            <TableHeader>
              <TableRow>
                <TableHead className="w-[70px] p-1 h-8">No</TableHead>
              ...
              <TableBody className="">
                {villageFile.map((village: any, index: number) => (
                  <TableRow
                    ...
                    className="cursor-pointer hover:bg-gray-100"
                  >
                    <TableCell className="font-medium p-1 w-[80px]">
                      {index + 1}
                    </TableCell>
                    <TableCell className="p-1 w-40">{village.name}</TableCell>
        ...
        <div className="flex-1 bg-white p-2 rounded col-span-4">
          ...
          <Table className="relative">
            <TableHeader className="">
              <TableRow>
                <TableHead className="w-[30px] p-1 h-8">No</TableHead>
                <TableHead className="p-1 w-40 h-8">Village</TableHead>
                {villagetype.length > 0 &&
                  villagetype[0].filetypelist.map(
                    (filetype: any, index: number) => (
                      <TableHead
                        key={index}
                        className="p-1 w-40 h-8 text-xs text-center"
